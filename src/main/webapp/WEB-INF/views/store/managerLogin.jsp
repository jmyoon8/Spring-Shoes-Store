...
<div id="contain">
	...
	<div class="c" id="header" >
		...
		<!--메인banner  -->
		<a href="main.host"><img src="/store/store/storePic/banner.jpg" width="700" height="150"></a>
	...
	<div class="join" id="contents" style="margin-top: 10">
		<form action="managerLoginPro.cus" method="post" name="login" style="margin-left: 150px;">
			<fieldset style="width: 250px" align="center">
				<legend>관리자 로그인</legend>
					<table style="border-collapse: collapse;" align="center">
						<tr>
							<td style="text-align: right;">아이디</td>
							<td><input type="text" name="hostId" required="required" size="15"></td>
						</tr>
						<tr>
							<td style="text-align: right;">비밀번호</td>
							<td><input type="password" name="hostPwd" required="required" size="15"></td>
						</tr>
						<tr>
